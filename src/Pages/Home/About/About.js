        ...
        <div>
            <div className="hero lg:w-5/6 md:w-5/6 sm:w-full mx-auto md:mt-24 lg:mt-24">
                <div className="hero-content flex-col lg:flex-row-reverse md:flex-row-reverse ">
                    <img src="https://dynamic.com.bd/public/assets/img/home.jpg" className=" lg:w-1/2 md:w-1/2 sm:w-4/6 shadow-2xl md:h-64 sm:h-64 lg:h-80 hidden md:block lg:block" alt='img' />
